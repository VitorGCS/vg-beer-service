...
import guru.springframework.vgbeerservice.web.controller.NotFoundException;
import guru.springframework.vgbeerservice.web.mappers.BeerMapper;
import guru.springframework.vgbeerservice.web.mappers.BeerMapperDecorator;
...
public class BeerServiceImpl implements BeerService {
    ...
    public BeerDto getByUpc(String upc) {
        System.out.println(" getByUpc(upc). "+ upc );
